      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addautor.php" method="post">
			 <div class="form-row">
                      ...
                      <tbody>
                        <?php 
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $d['FECHA_NACIMIENTO']; ?>
                              </td>
                              <td class="td-actions">
						  <a href="updateautor.php?id=<?= $d['ID_AUTOR'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="deleteautor.php?id=<?= $d['ID_AUTOR'] ?>" 
