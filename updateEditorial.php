          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($conexion,"SELECT * FROM EDITORIAL WHERE ID_EDITORIAL = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>

<form class="form-horizontal" action="bdEditorial.php" method="post">
			 <div class="form-row">
...
<div class="form-group col-md-6">
  ...
  <input type="text" class="form-control" name="nombre_editorial" value="<?= $d['NOMBRE_EDITORIAL'] ?>">
</div>
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<div class="form-row">
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="telefono_principal" value="<?= $d['TELEFONO_PRINCIPAL'] ?>">
				</div>				
			  </div>	
