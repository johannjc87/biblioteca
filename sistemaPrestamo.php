            ...
            <div class="col-md-12">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Prestamo de Libros</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT * from PRESTAMO');
                            oci_execute($stid);
                            while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
                                ?>
                            <tr>
                              <td>
                                <?php echo $d['ID_PRESTAMO']; ?>
                              </td>
                              <td>
                              ...
                              <td>
                              <?php echo $d['FECHA_SALIDA']; ?>
                              </td>
                              <td>
                                <?php echo $d['FECHA_MAXIMA']; ?>
                              </td>
                              <td>
                                <?php echo $d['FECHA_ENTREGA']; ?>
                              </td>
                              <td>
                                <?php echo $d['ANOTACION']; ?>
                              </td>
