      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addFuncionario.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID Funcionario</label>
				  <input type="text" class="form-control" name="ID_FUNCIONARIO" >
				</div>
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="ID_SEDE" >   <!-- LLAVE FORANEA -->
				</div>	
                <div class="form-group col-md-6">
				  <label for="">Status Laboral</label>
				  <input type="text" class="form-control" name="STATUS_LABORAL" >
				</div>	
                <div class="form-group col-md-6">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos de Funcionario (LLave foranea, ID Sede)</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT * from FUNCIONARIO');
                            oci_execute($stid);
