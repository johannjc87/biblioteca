      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addObsoletos.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID Libro Obsoletos</label>
				  <input type="text" class="form-control" name="ID_OBSOLETO" >
				</div>
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos de Libros Obsoletos</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT * from LIBROS_OBSOLETOS');
                            oci_execute($stid);
                            while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
                                ?>
                            <tr>
                              <td>
                                <?php echo $d['ID_OBSOLETO']; ?>
                              </td>
                              <td>
                                <?php echo $d['ID_LIBRO']; ?>
                              </td>
