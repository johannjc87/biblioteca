            ...
            <div class="col-md-12">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Función: Pago de ISLR</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT ID_FUNCIONARIO, NOMBRE_FUNCIONARIO, SALARIO, ISLR(SALARIO) from FUNCIONARIO');
                            oci_execute($stid);
