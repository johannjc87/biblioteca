      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addSede.php" method="post">
			 <div class="form-row">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos de Sede</h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT * from SEDE');
                            oci_execute($stid);
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $d['NOMBRE_SEDE']; ?>
                              </td>
                              <td>
                                <?php echo $d['UBICACION']; ?>
                              </td>
                              
                              
                              <td class="td-actions">
						  <a href="updateSede.php?id=<?= $d['ID_SEDE'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="deleteSede.php?id=<?= $d['ID_SEDE'] ?>" 
