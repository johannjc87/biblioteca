      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addEstudiante.php" method="post">
			 <div class="form-row">
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="USUARIO" >   <!-- LLAVE FORANEA -->
				</div>	
                <div class="form-group col-md-6">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos de Estudiante</h4>
                      ...
                      <tbody>
                        <?php 
                            ...
                            <tr>
                              ...
                              <td class="td-actions">
						  <a href="updateEstudiante.php?id=<?= $d['ID_ESTUDIANTE'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="deleteEstudiante.php?id=<?= $d['ID_ESTUDIANTE'] ?>" 
