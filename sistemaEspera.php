      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addEspera.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID Espera</label>
				  <input type="text" class="form-control" name="ID_ESPERA" >
				</div>
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos del Lista de Espera </h4>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                            ...
                            $stid = oci_parse($conexion, 'SELECT * from LISTA_ESPERA');
                            oci_execute($stid);
                            while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
                                ?>
                            <tr>
                              <td>
                                <?php echo $d['ID_ESPERA']; ?>
                              </td>
                              <td>
