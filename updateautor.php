...
<form class="form-horizontal" action="pupdateautor.php" method="post">
			 <div class="form-row">
       ...
       <input type="text" class="form-control" name="id_autor" value="<?= $d['ID_AUTOR'] ?>" >
				...
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="nombre_autor" value="<?= $d['NOMBRE_AUTOR'] ?>">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
				  <label for="">Fecha Nacimiento</label>
				  <input type="text" class="form-control" name="fecha_nacimiento" value="<?= $d['FECHA_NACIMIENTO'] ?>">
				</div>				
			  </div>	
