			...
			<form class="form-horizontal" action="addLibro.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="ID_LIBRO" >
				</div>
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="ID_LENGUAJE" >   
				</div>	
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="TECNOLOGIA" >
				</div>	
                <div class="form-group col-md-6">
                      ...
                      <tbody>
                        <?php 
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $d['ID_LENGUAJE']; ?>
                              </td>
                              <td>
                              <?php echo $d['ID_AUTOR']; ?>
                              </td>
                              <td>
                                <?php echo $d['TECNOLOGIA']; ?>
                              </td>
                              <td>
                                <?php echo $d['ID_SEDE']; ?>
                              </td>
                              <td>
                                <?php echo $d['ID_EDITORIAL']; ?>
                              </td>
                              <td>
                                <?php echo $d['DISPONIBILIDAD']; ?>
                              </td>
                              
                              
                              <td class="td-actions">
						  <a href="updateLibro.php?id=<?= $d['ID_LIBRO'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="deleteLibro.php?id=<?= $d['ID_LIBRO'] ?>" 
							onclick="return confirm('¿Estás seguro que deseas eliminar los datos?')">
