      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<form class="form-horizontal" action="addEditorial.php" method="post">
			 <div class="form-row">
             ...
             <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Datos de Editorial</h4>
                      ...
                      <tbody>
                        <?php 
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $d['NOMBRE_EDITORIAL']; ?>
                              </td>
                              <td>
                                <?php echo $d['DIRECCION']; ?>
                              </td>
                              <td>
                                <?php echo $d['TELEFONO_PRINCIPAL']; ?>
                              </td>
                              
                              <td class="td-actions">
						  <a href="updateEditorial.php?id=<?= $d['ID_EDITORIAL'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="deleteEditorial.php?id=<?= $d['ID_EDITORIAL'] ?>" 
